...
public abstract class SaveAndReloadChecks <D extends Database<D, G, E, I>, G extends Group<D,G,E,I>, E extends Entry<D,G,E,I>, I extends Icon>{
    ...
    public abstract void saveDatabase(D database, StreamFormat streamFormat, Credentials credentials, OutputStream outputStream) throws IOException;
    ...
    public void saveAndReloadTest() throws IOException {
        ...
        D input = loadDatabase(new KdbxCreds("123".getBytes()), fis);
    ...
    public void saveAndReloadTest2() throws IOException {
        D attachment = getDatabase("Attachment.kdbx", new KdbxCreds("123".getBytes()));
