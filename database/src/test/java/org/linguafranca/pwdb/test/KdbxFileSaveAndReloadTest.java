 ...
 * @author jo
 */
public interface KdbxFileSaveAndReloadTest {
    ...
    boolean verifyStreamFormat(StreamFormat<?> s1, StreamFormat<?> s2);
     ...
     */
    @Test
    default void saveAndReloadTest() throws IOException {
     ...
     */
    @Disabled
    default void inspectNewDatabase () throws IOException {
        Database database = createNewDatabase();
    ...
    // the assertions here somewhat duplicate those elsewhere
    @Test
    default void testNewDatabase() throws IOException {
        Database database = createDatabase();
