 ...
 * @author Jo
 */
public class HashBlockOutputStream extends OutputStream {

    private static final int BLOCK_SIZE = 8 * 1024;
    private final static int HASH_SIZE = 32;
    private final byte[] ZERO_HASH = new byte[HASH_SIZE];
    private int nextSequenceNumber = 0;
    private final MessageDigest md5 = Encryption.getMessageDigestInstance();
     ...
     */
    public HashBlockOutputStream(OutputStream outputStream) {
     ...
     */
    public HashBlockOutputStream(OutputStream outputStream, boolean littleEndian) {
