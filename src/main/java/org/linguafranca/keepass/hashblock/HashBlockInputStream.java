 ...
 * @author Jo
 */
public class HashBlockInputStream extends InputStream {
     ...
     */
    public HashBlockInputStream(InputStream inputStream) {
     ...
     */
    public HashBlockInputStream(InputStream inputStream, boolean littleEndian) {
